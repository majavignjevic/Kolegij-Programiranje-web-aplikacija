...
<body class="unos">
    ...
    <h1>WILLKOMMEN</h1>
    <form enctype="multipart/form-data" action="registracija-novi.php" method="POST" name="loginNovi">
        <div class="form-item">
        ...
        <div class="form-item">
            <label for="surname">Unesite svoje prezime: </label>
            <div class="form-field">
        ...
        <div class="form-item">
            <label for="password1">Ponovite svoju lozinku: </label>
            <div class="form-field">
